...
curl -LJ https://github.com/holochain/elemental-chat/releases/download/v0.2.5/holo-dev-server.zip -o ./bin/holo-dev-server.zip
unzip ./bin/holo-dev-server.zip -d ./bin